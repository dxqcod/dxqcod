# Привет 👋
Здесь проекты, связанные с микроконтроллепами esp, Arduino, nrf, полётные контроллеры, их интеграции с сервисами telegram, meshtastic и др, а также идеи just for fun. 
