# Привет 👋
Здесь реально работающие проекты, связанные с микроконтроллерами esp, Arduino, nrf, полётные контроллеры,приемоперелатчиками Lora, ретрансляторы, интеграции всех устройств с сервисами telegram, vk, meshtastic и др, а также лёгкие идеи в стиле "just for fun". 
