# Привет 👋
Здесь реально работающие проекты, связанные с  raspberry, микроконтроллерами esp8266, esp32, Arduino, nRF52840, полётные контроллеры,приемоперелатчиками Lora, ретрансляторы, интеграции всех устройств с сервисами telegram, vk, meshtastic и др, а также лёгкие идеи в стиле "just for fun". 
