# Привет 👋
Здесь реально работающие проекты, связанные с микроконтроллерами esp, Arduino, nrf, полётные контроллеры, их интеграции с сервисами telegram, meshtastic и др, а также реализации в стиле "just for fun". 
